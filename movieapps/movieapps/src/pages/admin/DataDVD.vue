      ...
      <div class="col-md-12 col-xs-12 col-lg-12">
        <div class="row">
          ...
          <div class="col">
           ...
           <div>Data Transaksi Katalog DVD Anda</div>
          </q-banner>
          </div>
          </div>
        </div>
          ...
          <q-tr :props="props">
            ...
            <q-td key="aksi" :props="props">
              <div class="row q-gutter-md">
                <q-btn :to="{ name: 'formEditDVD', params: { id:props.row._id }}" label="Edit" icon="edit" color="warning" unelvated/>
                <q-btn @click="deleteMovie(props.row._id)" label="Hapus" icon="delete" color="negative" unelvated/>
              </div>
            </q-td>
          </q-tr>
        </template>
  ...
  data () {
    return {
      columns: [
        ...
        { name: 'harga', align: 'left', label: 'Harga Film', field: 'harga', sortable: true },
